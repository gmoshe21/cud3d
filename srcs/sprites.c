...
/*   Updated: 2020/10/12 16:59:44 by gmoshe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_sprit(t_cub *cub, int spriteorder[cub->spnum])
{
	int		i;
...
void	sprites_next(t_cub *cub, t_raycast *rc, double *zbuffer)
{
	...
	if (cub->extension_height - cub->extension_width > 500)
		rc->spritewidth = abs((int)(cub->extension_width / (rc->transformy)));
